  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#070B18] text-slate-800 dark:text-slate-100 relative font-sans antialiased transition-colors duration-200 selection:bg-purple-500 selection:text-white pb-16">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
        <div className="absolute -top-40 -left-40 w-[32rem] h-[32rem] rounded-full bg-purple-500/10 dark:bg-purple-600/15 blur-3xl" />
        <div className="absolute top-1/3 -right-40 w-[32rem] h-[32rem] rounded-full bg-indigo-500/10 dark:bg-indigo-600/15 blur-3xl" />
        <div className="absolute -bottom-40 left-1/4 w-[32rem] h-[32rem] rounded-full bg-blue-500/10 dark:bg-blue-600/10 blur-3xl" />
      </div>
      ...
      <header className="sticky top-0 z-30 bg-white/90 dark:bg-[#0E152C]/90 backdrop-blur-xl border-b border-slate-200/80 dark:border-slate-800/80 shadow-2xs transition-colors">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
          ...
          >
            <div className="w-10 h-10 rounded-xl bg-black border border-purple-500/40 overflow-hidden flex items-center justify-center shadow-md shadow-purple-500/20 group-hover:scale-105 transition-transform flex-shrink-0">
              <img 
                src="/logo.png" 
                alt="KAAVALX Logo" 
            ...
            <div>
              <div className="flex items-center space-x-2">
                <span className="text-lg font-black tracking-tight bg-gradient-to-r from-purple-600 via-violet-600 to-indigo-600 dark:from-white dark:via-purple-200 dark:to-indigo-300 bg-clip-text text-transparent">
                  KAAVALX
                </span>
                <span className="text-[10px] font-bold px-2.5 py-0.5 rounded-full bg-emerald-100 text-emerald-700 dark:bg-emerald-500/20 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-500/30 flex items-center gap-1.5">
                  <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse"></span>
                  FREE SCAM SCANNER
                </span>
              </div>
              <p className="text-[11px] text-slate-500 dark:text-slate-400 font-medium hidden sm:block">
                AI Cyber Defense & Phishing Protection Engine
              </p>
            </div>
          </Link>
          ...
          <div className="flex items-center space-x-2 sm:space-x-3">
            <button
              ...
              className={`inline-flex items-center space-x-1.5 px-3.5 py-2 text-xs font-bold rounded-xl transition-all cursor-pointer shadow-2xs ${
                activeTab === 'advisor'
            ...
            <Link
              to="/login"
              className="inline-flex items-center space-x-1.5 px-4 py-2 text-xs font-bold rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-200 border border-slate-200 dark:border-slate-700 transition-all shadow-2xs hover:scale-[1.02] active:scale-[0.98]"
      ...
      <main className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 pt-6 sm:pt-8 space-y-6">
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-sm sm:text-base text-slate-600 dark:text-slate-300 max-w-2xl mx-auto leading-relaxed">
            Instantly scan suspicious SMS, WhatsApp messages, bank notices, and web links for credential phishing, OTP traps, and deceptive typosquatting.
          </p>
        </div>
        ...
        {activeTab === 'scanner' && (
          <div className="space-y-6 animate-fade-in">
            ...
            {/* Incident Scenario Presets Strip */}
            <div className="bg-white/80 dark:bg-[#0E152C]/80 backdrop-blur-md p-4 sm:p-5 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xs space-y-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2 text-slate-800 dark:text-slate-200">
                  <Sparkles className="w-4 h-4 text-purple-600 dark:text-purple-400" />
                  <span className="text-xs font-bold uppercase tracking-wider">Test With Sample Scenarios:</span>
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2.5">
                {PRESET_CASES.map((preset, idx) => (
                  <button
                    ...
                    className="p-3 rounded-xl border text-left text-xs transition-all duration-150 cursor-pointer bg-slate-50 dark:bg-slate-900/60 hover:bg-purple-50/80 dark:hover:bg-purple-950/30 border-slate-200 dark:border-slate-800 hover:border-purple-300 dark:hover:border-purple-700/60 group shadow-2xs"
                  >
            ...
            <div className="bg-white dark:bg-[#0E152C] rounded-3xl p-5 sm:p-7 border border-slate-200 dark:border-slate-800 shadow-xl dark:shadow-black/40 space-y-5 transition-colors">
              
              {/* Header & Clipboard Controls */}
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-2 border-b border-slate-100 dark:border-slate-800">
                <div className="flex items-center space-x-2">
                  ...
                  <label htmlFor="scam-text-input" className="text-xs sm:text-sm font-bold text-slate-800 dark:text-slate-200">
                    Paste the message, SMS, email body, or website link:
                  </label>
                </div>
                ...
                <div className="flex items-center space-x-2 self-end sm:self-auto">
                  <button
                    ...
                    className="inline-flex items-center space-x-1.5 px-3 py-1.5 text-xs font-semibold text-purple-700 dark:text-purple-300 bg-purple-50 dark:bg-purple-950/40 hover:bg-purple-100 dark:hover:bg-purple-900/60 rounded-lg border border-purple-200 dark:border-purple-800/50 transition-colors cursor-pointer"
                  ...
                  {inputText && (
                    <button
                      type="button"
                      onClick={handleClear}
                      className="inline-flex items-center space-x-1 px-2.5 py-1.5 text-xs font-medium text-slate-500 hover:text-red-600 dark:text-slate-400 dark:hover:text-red-400 transition-colors cursor-pointer"
              ...
              <div className="relative">
                <textarea
                  ...
                  placeholder="e.g. URGENT: Your bank account has been locked. Click http://bank-update-kyc.online immediately to share your 6-digit OTP code..."
                ...
                <div className="flex items-center justify-between text-[11px] text-slate-400 px-1 mt-1">
                  ...
                  <span>Supports Emails, SMS, WhatsApp Text, & Links</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 items-end pt-1">
                <div className="sm:col-span-2">
                  <label htmlFor="sender-input" className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1.5 flex items-center space-x-1.5">
                    ...
                    <span>Sender's Email, Phone, or Header (Optional):</span>
                  </label>
                  <input
                    id="sender-input"
                    type="text"
                ...
                <div className="space-y-6 animate-fade-in">
                  ...
                  <div className={`p-5 sm:p-6 rounded-2xl border flex flex-col sm:flex-row items-start justify-between gap-4 transition-colors ${
                    ...
                    <div className="flex items-start space-x-3.5">
                      {result.security?.threat_detected ? (
                        <ShieldAlert className="w-7 h-7 text-rose-600 dark:text-rose-400 flex-shrink-0 mt-0.5" />
                      ) : (
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white dark:bg-slate-900 p-5 sm:p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xs space-y-4 transition-colors">
                      <h4 className="text-xs font-bold uppercase tracking-wider text-blue-700 dark:text-blue-400 border-b border-slate-100 dark:border-slate-800 pb-2.5 flex items-center space-x-2">
                      ...
                      <div className="grid grid-cols-2 gap-3 text-xs">
                        <div>
                          ...
                          <p className="font-semibold text-slate-900 dark:text-white mt-0.5">{result.category || 'General'}</p>
                        </div>
                        <div>
                          <span className="text-slate-500 dark:text-slate-400 font-medium">Issue Summary:</span>
                          <p className="font-semibold text-slate-900 dark:text-white mt-0.5">{result.issue || 'Inquiry'}</p>
                        </div>
                        <div>
                          <span className="text-slate-500 dark:text-slate-400 font-medium">Sentiment:</span>
                          <div className="mt-1"><SentimentBadge sentiment={result.sentiment || 'Neutral'} /></div>
                        </div>
                        <div>
                          <span className="text-slate-500 dark:text-slate-400 font-medium">Emotion:</span>
                          <p className="font-semibold text-slate-900 dark:text-white mt-0.5">{result.emotion || 'Neutral'}</p>
                        </div>
                        <div>
                          <span className="text-slate-500 dark:text-slate-400 font-medium">Urgency:</span>
                          <p className="font-semibold text-slate-900 dark:text-white mt-0.5">{result.urgency || 'Normal'}</p>
                        </div>
                        <div>
                          <span className="text-slate-500 dark:text-slate-400 font-medium">Priority:</span>
                          <div className="mt-1"><PriorityBadge level={result.priority || 'P3'} /></div>
                        </div>
                        <div className="col-span-2">
                          <span className="text-slate-500 dark:text-slate-400 font-medium">Resolution Status:</span>
                          <div className="mt-1"><ResolutionBadge status={result.resolution_status || 'Open'} /></div>
                        </div>
                      </div>
                      ...
                      <div className="pt-2 border-t border-slate-100 dark:border-slate-800 space-y-2.5 text-xs">
                        <div>
                          ...
                          <p className="text-slate-600 dark:text-slate-300 mt-1 leading-relaxed bg-slate-50 dark:bg-slate-800/60 p-3 rounded-xl border border-slate-100 dark:border-slate-700/60">
                            {result.summary}
                          </p>
                        </div>
                        <div>
                          <span className="font-semibold text-slate-700 dark:text-slate-300">Customer Request:</span>
                          <p className="text-slate-600 dark:text-slate-300 mt-1 bg-slate-50 dark:bg-slate-800/60 p-3 rounded-xl border border-slate-100 dark:border-slate-700/60">
                    ...
                    {/* Card 2: Security Forensics Intelligence */}
                    <div className="bg-white dark:bg-slate-900 p-5 sm:p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xs space-y-4 transition-colors">
                      <h4 className="text-xs font-bold uppercase tracking-wider text-rose-600 dark:text-rose-400 border-b border-slate-100 dark:border-slate-800 pb-2.5 flex items-center space-x-2">
                        <ShieldAlert className="w-4 h-4" />
                        <span>Security Threat & Phishing Intelligence</span>
                      </h4>

                      <div className="grid grid-cols-2 gap-3 text-xs">
                        <div>
                          <span className="text-slate-500 dark:text-slate-400 font-medium">Threat Detected:</span>
                          <p className={`font-semibold mt-0.5 ${result.security?.threat_detected ? 'text-rose-600 dark:text-rose-400' : 'text-emerald-600 dark:text-emerald-400'}`}>
                            {result.security?.threat_detected ? 'YES' : 'NO'}
                          </p>
                        </div>
                        <div>
                          <span className="text-slate-500 dark:text-slate-400 font-medium">Threat Type:</span>
                          <p className="font-semibold text-slate-900 dark:text-white mt-0.5">{result.security?.threat_type || 'None'}</p>
                        </div>
                        <div>
                          <span className="text-slate-500 dark:text-slate-400 font-medium">Social Engineering:</span>
                          <p className="font-semibold text-slate-900 dark:text-white mt-0.5">{result.security?.social_engineering ? 'Detected' : 'None'}</p>
                        </div>
                        <div>
                          <span className="text-slate-500 dark:text-slate-400 font-medium">Credential Theft:</span>
                          <p className={`font-semibold mt-0.5 ${result.security?.credential_request ? 'text-rose-600 dark:text-rose-400' : 'text-slate-700 dark:text-slate-300'}`}>
                        ...
                        <div>
                          ...
                          <p className={`font-semibold mt-0.5 ${result.security?.otp_request ? 'text-rose-600 dark:text-rose-400' : 'text-slate-700 dark:text-slate-300'}`}>
                        ...
                        <div>
                          ...
                          <p className="font-semibold text-slate-900 dark:text-white mt-0.5">{result.security?.suspicious_message ? 'Urgency / Fear language' : 'Normal tone'}</p>
                        </div>
                      </div>
                        ...
                        <div className="pt-2 border-t border-slate-100 dark:border-slate-800">
                          ...
                          <div className="flex flex-wrap gap-1.5 mt-1.5">
                            {result.security.techniques.map((tech, i) => (
                              <span key={i} className="px-2.5 py-1 bg-rose-50 dark:bg-rose-900/30 text-rose-700 dark:text-rose-300 border border-rose-200 dark:border-rose-800/60 rounded-lg text-[11px] font-semibold">
                                {tech}
                              </span>
                            ))}
                          </div>
                      ...
                      {result.urls && result.urls.length > 0 && (
                        <div className="pt-2 border-t border-slate-100 dark:border-slate-800">
                          ...
                          <div className="mt-1.5 space-y-1.5">
                            {result.urls.map((u, i) => (
                              <div key={i} className="p-2.5 bg-slate-50 dark:bg-slate-800/70 border border-slate-200 dark:border-slate-700 rounded-xl text-xs space-y-1 font-mono">
                  ...
                  <div className="bg-white dark:bg-slate-900 p-5 sm:p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xs transition-colors">
                    <h4 className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-2 flex items-center space-x-1.5">
                      ...
                      <span>Recommended Safety & Mitigation Action</span>
                    </h4>
                    <p className="text-sm font-semibold text-slate-900 dark:text-slate-100 bg-purple-50/70 dark:bg-purple-950/40 p-3.5 rounded-xl border border-purple-100 dark:border-purple-900/50 text-purple-900 dark:text-purple-200 leading-relaxed">
                      {result.recommended_action}
                    </p>
                  </div>

                  {/* Share & Report Toolbar */}
                  <div className="bg-white dark:bg-slate-900 p-4 sm:p-5 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xs flex flex-wrap items-center justify-between gap-3">
                    <div className="flex items-center space-x-2.5">
                      <button
                        type="button"
                        onClick={handleCopyReport}
                        className="inline-flex items-center space-x-1.5 px-3.5 py-2 rounded-xl text-xs font-semibold bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-200 border border-slate-200 dark:border-slate-700 transition-colors cursor-pointer shadow-2xs"
                      >
